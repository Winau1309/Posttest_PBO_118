...
public final class KonserKpop extends Konser implements Festival{
    private String band;
    private int harga;
    private String namaArtis;
    private String lokasiKonser;

    public KonserKpop(String namaKonser, String alamat, String tanggal, String band, int harga, String namaArtis, String lokasiKonser) {
